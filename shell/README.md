...
This directory contains shell integration examples for the Analyst template.
...
| File | Purpose |
|------|---------|
| `analyst_profile.zsh` | Example zsh profile for analyst agents |
...
source shell/analyst_profile.zsh
```
...
1. Copy `analyst_profile.zsh` to your instance
...
*Shell integration for template-analyst-aget*
