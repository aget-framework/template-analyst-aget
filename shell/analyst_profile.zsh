#!/bin/zsh
# ============================================================
# Analyst Agent Shell Profile
# ============================================================
# Template: template-analyst-aget
# Version: 3.3.0
#
# DOCUMENTATION
# -------------
# Shell README:    ./shell/README.md
# Template Spec:   ./specs/Analyst_SPEC.md
# Template Vocab:  ./specs/Analyst_VOCABULARY.md
...
# 2. Source this file: source shell/analyst_profile.zsh
...
# ============================================================
export AGET_AGENT_NAME="${AGET_AGENT_NAME:-template-analyst-aget}"
export AGET_ARCHETYPE="analyst"
...
# ============================================================
export AGET_SPEC="${AGET_AGENT_DIR}/specs/Analyst_SPEC.md"
export AGET_VOCAB="${AGET_AGENT_DIR}/specs/Analyst_VOCABULARY.md"
